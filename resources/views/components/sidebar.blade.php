<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        /
        ">
            <img alt="Logo" src="{{ asset('assets/images/logo.webp') }}" class="h-50px app-sidebar-logo-default" />
            <img alt="Logo" src="{{ asset('assets/images/logo.webp') }}" class="h-30px app-sidebar-logo-minimize" />
        </a>
