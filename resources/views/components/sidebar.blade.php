    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                {{-- Dashboard --}}
                <div class="menu-item">
                    <a href="{{route('home.index')}}" class="menu-link {{ Route::is('home.index') ? 'active' : '' }}">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::is('data.*') ? 'active' : '' }}" href="
                                    {{ route('data.index') }}
                                    ">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::is('shortcut.*') ? 'active' : '' }}" href="
                        ...
                        <span class="menu-title">Sandi</span>
                    </a>
                </div>
                <hr>
                ...
                @auth
                <div class="menu-item">
                    <a class="menu-link {{ Route::is('home') ? 'active' : '' }}" href="
                                    {{ route('home') }}
                                    ">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                @can('location-list')
                <div class="menu-item">
                    <a class="menu-link {{ Route::is('location.*') ? 'active' : '' }}" href="
                        ...
                        <span class="menu-title">Lokasi Patroli</span>
                    </a>
                </div>
                @endcan

                <div class="menu-item">
                    <a class="menu-link {{ Route::is('patroli.*') ? 'active' : '' }}" href="
                                    {{ route('patroli.index') }}
                                    ">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                        ...
                        <span class="menu-title">Patroli</span>
                    </a>
                </div>

                @can('apar-list')
                <div class="menu-item">
                    <a class="menu-link {{ Route::is('apar.*') ? 'active' : '' }}" href="
                                    {{ route('apar.index') }}
                                    ">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::is('apar_scan.*') ? 'active' : '' }}" href="
                                    {{ route('apar_scan.index') }}
                                    ">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                @if (Auth::user()->role_name != 'ANGGOTA')
                <div class="menu-item">
                    <a class="menu-link {{ Route::is('apar_report.*') ? 'active' : '' }}" href="
                                    {{ route('apar_report.filter') }}
                                    ">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                        ...
                        <span class="menu-title">Laporan APAR</span>
                    </a>
                </div>    
                @endif
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::is('admin.report') ? 'active' : '' }}" href="
                                    {{ route('admin.report') }}
                                    ">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::is('admin.patroli') ? 'active' : '' }}" href="
                                    {{ route('admin.patroli') }}
                                    ">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-database-fill" viewBox="0 0 16 16">
                        ...
                        <span class="menu-title">Data Patroli</span>
                    </a>
                </div>
                @can('role-list')
                <div class="menu-item">
                    <a class="menu-link {{ Route::is('role.*') ? 'active' : '' }}" href="
                                    {{ route('role.index') }}
                                    ">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
