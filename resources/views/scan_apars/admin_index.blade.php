            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('admin.patroli') }}" class="text-muted">Data Patroli &nbsp;</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
...
<div class="card card-flush">
    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
            <a type="button" class="btn btn-active-primary btn-primary ms-2" href="{{route('patroli.create')}}" id="addButton">
...
<script>
    $('#patroli-table').on("click", ".id-check", function(e) {
...
<script>
    $(document).on("click", "#delete-confirm", function(e) {
            ...
            $('.id-check:checkbox:checked').each(function(i, obj){
                patroli_id.push($(obj).val());
            });

            var title_modal = patroli_id.length + ' Patroli Akan Dihapus';
            ...
            Swal.fire({
                ...
                title: title_modal,
                text: "Apakah Anda yakin ingin menghapus data patroli yang diseleksi? Data yang telah terhapus tidak dapat dipulihkan.",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    var route = "{{ route('patroli.delete') }}";
                    $.ajax({
                        url: route,
                        type: 'POST',
                        data: {
                            _token: $("meta[name='csrf-token']").attr("content"),
                            patroli_id: patroli_id
                        },
                        success: function(response) {
                            Swal.fire({
                                ...
                                title: 'Data patroli telah Dihapus',
                                text: 'Data patroli yang diseleksi berhasil dihapus',
                                icon: 'success',
                        ...
                        error: function(xhr) {
                            ...
                            Swal.fire({
                                ...
                                title: 'Error',
                                text: "Tidak dapat menghapus patroli, terjadi error!",
                                icon: 'error',
                                confirmButtonText: 'OK'
                            })
                        }
